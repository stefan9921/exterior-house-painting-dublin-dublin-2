...
const PAGE_URL = `${business.siteUrl}/faq/`;

export const metadata: Metadata = {
  title: "Painting FAQs Dublin | Exterior House Painting Dublin",
  description:
  ...
  openGraph: {
    title: "Painting FAQs Dublin | Exterior House Painting Dublin",
    description:
      "Answers to common Dublin painting questions: cost per room, full-house pricing, best time of year and painter day rates.",
    url: PAGE_URL,
  },
};
            ...
            {faqs.map((f, i) => (
              ...
              >
                <summary className="flex justify-between items-center p-6 cursor-pointer list-none">
                  <h2 className="font-headline-sm text-lg font-bold pr-4 m-0">{f.q}</h2>
